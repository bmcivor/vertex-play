...
- Verify the Jenkins container can push to `shadowlands:5000` using the host Docker socket (covers P4 from `builder-image.md`).
...
- Contingent insecure-registries change (only if P6 in `builder-image.md` turns out red).
